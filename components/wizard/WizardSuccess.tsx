    ...
    return (
        <div className="max-w-3xl mx-auto py-12 px-4 animate-fade-in">
            <div className="bg-white rounded-[2.5rem] p-8 md:p-12 shadow-[0_20px_50px_rgba(0,0,0,0.08)] border border-brand-border text-center overflow-hidden relative">
                ...
                {/* Link Card */}
                <div className="bg-brand-light/50 border border-brand-border rounded-3xl p-6 mb-10 relative group">
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-3">
                        ...
                        <div className="flex items-center gap-2 w-full sm:w-auto">
                            <button 
                                ...
                                className="flex-1 sm:flex-initial inline-flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-white border border-brand-border text-brand-dark font-bold text-sm hover:border-primary hover:text-primary transition-all active:scale-95"
                            >
                            ...
                            <a 
                                ...
                                className="flex-1 sm:flex-initial inline-flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-primary text-white font-bold text-sm hover:bg-primary-dark transition-all active:scale-95"
                            >
                    ...
                    <p className="text-xs text-brand-text-muted mt-4 italic">
                        Usa este link para ver, editar o confirmar tu reserva más tarde.
                    </p>
                </div>
