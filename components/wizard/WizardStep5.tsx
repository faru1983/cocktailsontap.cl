...
export default function WizardStep5({ wizard, cocktails, comunas }: Props) {
    const { state, goToStep } = wizard;
    const data = useMemo(() => wizard.calculateSummaryData(), [wizard, state.selections, state.eventData, state.contact]);

    return (
        <div className="flex flex-col">
            <h3 className="text-2xl font-extrabold text-brand-text mb-2">5. Resumen de Cotización</h3>
