...
export default function WizardStep2({ wizard, comunas }: Props) {
    ...
    return (
        <div className="flex flex-col space-y-6">
            ...
            {/* Fila 1: Nombre Completo y Email (Obligatorios) */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <label htmlFor="wizard-firstname" className="block font-bold mb-2 text-brand-text text-[0.9rem]">Nombre y Apellido <span className="text-primary">*</span></label>
                    <input
                        id="wizard-firstname"
                        name="name"
                        autoComplete="name"
